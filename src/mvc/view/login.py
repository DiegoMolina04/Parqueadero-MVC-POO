...
"font: 8pt \"Courier\";")
        ...
        self.buttonEnviar.clicked.connect(self.verifyLogin)
    ...
    def verifyLogin(self):
        ...
        respuesta = loginController.controller(correo,contraseña)

        mensaje = QMessageBox()

        if respuesta:
            mensaje.setText(f'¡Bienvenido al sistema!')
            mensaje.setIcon(QMessageBox.Information)
        else:
            mensaje.setText(f'¡Datos incorrectos!')
